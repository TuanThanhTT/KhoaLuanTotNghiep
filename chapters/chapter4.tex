...
\hspace*{\parindent}Mối quan hệ giữa các thực thể trong CSDL tuân theo mô hình liên kết một-nhiều (One-to-Many), trong đó thực thể trung tâm quản lý dữ liệu động là \textbf{\texttt{detection\_history}}.
